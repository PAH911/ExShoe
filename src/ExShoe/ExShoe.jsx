...
export default function ExShoe() {
  ...
  let handleAddToCart = (shoe) => {
    ...
    if (index == -1) {
      ...
      // tạo ra 1 object mới từ object cũ và thêm 1 key mới là total
  ...
  // Tạo handle cho nút Delete
  let handleDelete = (idShoe) => {
    console.log("idShoe:", idShoe);
    // giỏ hàng 10 sp => xoá 1 sp => giỏ hàng còn 9 sp
